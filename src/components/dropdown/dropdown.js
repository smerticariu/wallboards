...
const Dropdown = ({ trigger, className = '', containerClassName = '', openOnHover, closeOnClick, value, children, ...props }) => {
  ...
  return (
    <span className={`c-dropdown ${className}`} ref={triggerRef} {...props}>
      <span
